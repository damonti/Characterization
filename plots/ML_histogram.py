...
# Define Data
df = pd.read_csv('~/Estimation/plots/ML_histogram.csv', delimiter=',')
df.pivot("Component", "ML", "Score").plot(kind='bar')
plt.xticks(rotation='horizontal')
plt.ylabel("1 - MAPE")
plt.xlabel("")
plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.05),
          ncol=6, fancybox=True, shadow=True, fontsize='small')
# Show
plt.savefig("ML_histogram.pdf")
plt.show()
