...
// Generated on: Jul 26 2022 12:10:21 CEST (Jul 26 2022 10:10:21 UTC)
...
module full_adder_7(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__1617(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [8:0] input1, input2;
  output [8:0] sum;
  wire [8:0] input1, input2;
  wire [8:0] sum;
  wire [8:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_7 \generate_N_bit_Adder[8].genblk1.f (input1[8],
       input2[8], carry[7], sum[8], UNCONNECTED);
endmodule
