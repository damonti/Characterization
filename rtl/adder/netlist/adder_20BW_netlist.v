...
// Generated on: Jul 26 2022 12:12:16 CEST (Jul 26 2022 10:12:16 UTC)
...
module full_adder_8(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__2802(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [9:0] input1, input2;
  output [9:0] sum;
  wire [9:0] input1, input2;
  wire [9:0] sum;
  wire [9:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_8 \generate_N_bit_Adder[9].genblk1.f (input1[9],
       input2[9], carry[8], sum[9], UNCONNECTED);
endmodule
