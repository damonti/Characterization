...
// Generated on: Jul 26 2022 12:18:49 CEST (Jul 26 2022 10:18:49 UTC)
...
module full_adder_11(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__8246(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [12:0] input1, input2;
  output [12:0] sum;
  wire [12:0] input1, input2;
  wire [12:0] sum;
  wire [12:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_11 \generate_N_bit_Adder[12].genblk1.f (input1[12],
       input2[12], carry[11], sum[12], UNCONNECTED);
endmodule
