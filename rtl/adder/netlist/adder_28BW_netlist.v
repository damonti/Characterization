...
// Generated on: Jul 26 2022 12:21:15 CEST (Jul 26 2022 10:21:15 UTC)
...
module full_adder_12(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__7098(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [13:0] input1, input2;
  output [13:0] sum;
  wire [13:0] input1, input2;
  wire [13:0] sum;
  wire [13:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_12 \generate_N_bit_Adder[13].genblk1.f (input1[13],
       input2[13], carry[12], sum[13], UNCONNECTED);
endmodule
