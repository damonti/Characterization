...
// Generated on: Jul 26 2022 15:03:35 CEST (Jul 26 2022 13:03:35 UTC)
...
module full_adder_15(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__5115(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [16:0] input1, input2;
  output [16:0] sum;
  wire [16:0] input1, input2;
  wire [16:0] sum;
  wire [16:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_15 \generate_N_bit_Adder[16].genblk1.f (input1[16],
       input2[16], carry[15], sum[16], UNCONNECTED);
endmodule
