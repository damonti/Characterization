...
// Generated on: Jul 26 2022 12:32:19 CEST (Jul 26 2022 10:32:19 UTC)
...
module full_adder_16(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__7482(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [17:0] input1, input2;
  output [17:0] sum;
  wire [17:0] input1, input2;
  wire [17:0] sum;
  wire [17:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_16 \generate_N_bit_Adder[17].genblk1.f (input1[17],
       input2[17], carry[16], sum[17], UNCONNECTED);
endmodule
