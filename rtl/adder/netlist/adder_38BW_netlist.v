...
// Generated on: Jul 26 2022 12:35:23 CEST (Jul 26 2022 10:35:23 UTC)
...
module full_adder_17(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__4733(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [18:0] input1, input2;
  output [18:0] sum;
  wire [18:0] input1, input2;
  wire [18:0] sum;
  wire [18:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_17 \generate_N_bit_Adder[18].genblk1.f (input1[18],
       input2[18], carry[17], sum[18], UNCONNECTED);
endmodule
