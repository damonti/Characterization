...
// Generated on: Jul 26 2022 12:38:37 CEST (Jul 26 2022 10:38:37 UTC)
...
module full_adder_18(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__6161(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [19:0] input1, input2;
  output [19:0] sum;
  wire [19:0] input1, input2;
  wire [19:0] sum;
  wire [19:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_18 \generate_N_bit_Adder[19].genblk1.f (input1[19],
       input2[19], carry[18], sum[19], UNCONNECTED);
endmodule
