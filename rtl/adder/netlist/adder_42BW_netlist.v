...
// Generated on: Jul 26 2022 12:41:59 CEST (Jul 26 2022 10:41:59 UTC)
...
module full_adder_19(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__9315(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [20:0] input1, input2;
  output [20:0] sum;
  wire [20:0] input1, input2;
  wire [20:0] sum;
  wire [20:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_19 \generate_N_bit_Adder[20].genblk1.f (input1[20],
       input2[20], carry[19], sum[20], UNCONNECTED);
endmodule
