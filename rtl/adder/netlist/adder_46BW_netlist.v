...
// Generated on: Jul 26 2022 12:49:11 CEST (Jul 26 2022 10:49:11 UTC)
...
module full_adder_21(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__2883(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [22:0] input1, input2;
  output [22:0] sum;
  wire [22:0] input1, input2;
  wire [22:0] sum;
  wire [22:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_21 \generate_N_bit_Adder[22].genblk1.f (input1[22],
       input2[22], carry[21], sum[22], UNCONNECTED);
endmodule
