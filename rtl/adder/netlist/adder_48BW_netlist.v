...
// Generated on: Jul 26 2022 12:52:57 CEST (Jul 26 2022 10:52:57 UTC)
...
module full_adder_22(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__2346(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [23:0] input1, input2;
  output [23:0] sum;
  wire [23:0] input1, input2;
  wire [23:0] sum;
  wire [23:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_22 \generate_N_bit_Adder[23].genblk1.f (input1[23],
       input2[23], carry[22], sum[23], UNCONNECTED);
endmodule
