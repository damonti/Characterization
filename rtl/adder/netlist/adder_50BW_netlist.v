...
// Generated on: Jul 26 2022 12:56:50 CEST (Jul 26 2022 10:56:50 UTC)
...
module full_adder_23(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__1666(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [24:0] input1, input2;
  output [24:0] sum;
  wire [24:0] input1, input2;
  wire [24:0] sum;
  wire [24:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_23 \generate_N_bit_Adder[24].genblk1.f (input1[24],
       input2[24], carry[23], sum[24], UNCONNECTED);
endmodule
