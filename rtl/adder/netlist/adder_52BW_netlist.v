...
// Generated on: Jul 26 2022 13:00:51 CEST (Jul 26 2022 11:00:51 UTC)
...
module full_adder_24(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__7410(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [25:0] input1, input2;
  output [25:0] sum;
  wire [25:0] input1, input2;
  wire [25:0] sum;
  wire [25:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_24 \generate_N_bit_Adder[25].genblk1.f (input1[25],
       input2[25], carry[24], sum[25], UNCONNECTED);
endmodule
