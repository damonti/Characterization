...
// Generated on: Jul 26 2022 13:05:08 CEST (Jul 26 2022 11:05:08 UTC)
...
module full_adder_25(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__6417(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [26:0] input1, input2;
  output [26:0] sum;
  wire [26:0] input1, input2;
  wire [26:0] sum;
  wire [26:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_25 \generate_N_bit_Adder[26].genblk1.f (input1[26],
       input2[26], carry[25], sum[26], UNCONNECTED);
endmodule
