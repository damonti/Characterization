...
// Generated on: Jul 26 2022 13:09:26 CEST (Jul 26 2022 11:09:26 UTC)
...
module full_adder_26(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__5477(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [27:0] input1, input2;
  output [27:0] sum;
  wire [27:0] input1, input2;
  wire [27:0] sum;
  wire [27:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_26 \generate_N_bit_Adder[27].genblk1.f (input1[27],
       input2[27], carry[26], sum[27], UNCONNECTED);
endmodule
