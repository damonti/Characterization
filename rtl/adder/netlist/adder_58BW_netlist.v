...
// Generated on: Jul 26 2022 13:13:54 CEST (Jul 26 2022 11:13:54 UTC)
...
module full_adder_27(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__2398(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [28:0] input1, input2;
  output [28:0] sum;
  wire [28:0] input1, input2;
  wire [28:0] sum;
  wire [28:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_27 \generate_N_bit_Adder[28].genblk1.f (input1[28],
       input2[28], carry[27], sum[28], UNCONNECTED);
endmodule
