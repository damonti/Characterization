...
// Generated on: Jul 26 2022 13:18:28 CEST (Jul 26 2022 11:18:28 UTC)
...
module full_adder_28(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__5107(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [29:0] input1, input2;
  output [29:0] sum;
  wire [29:0] input1, input2;
  wire [29:0] sum;
  wire [29:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_28 \generate_N_bit_Adder[29].genblk1.f (input1[29],
       input2[29], carry[28], sum[29], UNCONNECTED);
endmodule
