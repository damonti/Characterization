...
// Generated on: Jul 26 2022 15:06:11 CEST (Jul 26 2022 13:06:11 UTC)
...
module full_adder_29(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__6260(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [30:0] input1, input2;
  output [30:0] sum;
  wire [30:0] input1, input2;
  wire [30:0] sum;
  wire [30:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_29 \generate_N_bit_Adder[30].genblk1.f (input1[30],
       input2[30], carry[29], sum[30], UNCONNECTED);
endmodule
