...
// Generated on: Jul 26 2022 13:43:22 CEST (Jul 26 2022 11:43:22 UTC)
...
module full_adder_33(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__6783(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [34:0] input1, input2;
  output [34:0] sum;
  wire [34:0] input1, input2;
  wire [34:0] sum;
  wire [34:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_33 \generate_N_bit_Adder[34].genblk1.f (input1[34],
       input2[34], carry[33], sum[34], UNCONNECTED);
endmodule
