...
// Generated on: Jul 26 2022 13:48:44 CEST (Jul 26 2022 11:48:44 UTC)
...
module full_adder_20(x, y, c_in, s, c_out);
  ...
  wire x, y, c_in;
  wire s, c_out;
  FA1D0BWP g61__9945(.A (y), .B (x), .CI (c_in), .CO (c_out), .S (s));
endmodule

module full_adder_21(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
  FA1D0BWP g61__2883(.A (y), .B (x), .CI (c_in), .CO (c_out), .S (s));
endmodule

module full_adder_22(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
  FA1D0BWP g61__2346(.A (y), .B (x), .CI (c_in), .CO (c_out), .S (s));
endmodule

module full_adder_23(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
  FA1D0BWP g61__1666(.A (y), .B (x), .CI (c_in), .CO (c_out), .S (s));
endmodule

module full_adder_24(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
  FA1D0BWP g61__7410(.A (y), .B (x), .CI (c_in), .CO (c_out), .S (s));
endmodule

module full_adder_25(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
  FA1D0BWP g61__6417(.A (y), .B (x), .CI (c_in), .CO (c_out), .S (s));
endmodule

module full_adder_26(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
  FA1D0BWP g61__5477(.A (y), .B (x), .CI (c_in), .CO (c_out), .S (s));
endmodule

module full_adder_27(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
  FA1D0BWP g61__2398(.A (y), .B (x), .CI (c_in), .CO (c_out), .S (s));
endmodule

module full_adder_28(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
...
module full_adder_29(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
...
module full_adder_30(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
...
module full_adder_31(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
...
module full_adder_32(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
...
module full_adder_33(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
...
module full_adder_34(x, y, c_in, s, c_out);
  input x, y, c_in;
  output s, c_out;
  wire x, y, c_in;
  wire s, c_out;
  XOR3D0BWP g32__3680(.A1 (x), .A2 (y), .A3 (c_in), .Z (s));
endmodule

module adder(input1, input2, sum);
  input [35:0] input1, input2;
  output [35:0] sum;
  wire [35:0] input1, input2;
  wire [35:0] sum;
  wire [35:0] carry;
  wire UNCONNECTED;
  ...
  full_adder_20 \generate_N_bit_Adder[21].genblk1.f (input1[21],
       input2[21], carry[20], sum[21], carry[21]);
  full_adder_21 \generate_N_bit_Adder[22].genblk1.f (input1[22],
       input2[22], carry[21], sum[22], carry[22]);
  full_adder_22 \generate_N_bit_Adder[23].genblk1.f (input1[23],
       input2[23], carry[22], sum[23], carry[23]);
  full_adder_23 \generate_N_bit_Adder[24].genblk1.f (input1[24],
       input2[24], carry[23], sum[24], carry[24]);
  full_adder_24 \generate_N_bit_Adder[25].genblk1.f (input1[25],
       input2[25], carry[24], sum[25], carry[25]);
  full_adder_25 \generate_N_bit_Adder[26].genblk1.f (input1[26],
       input2[26], carry[25], sum[26], carry[26]);
  full_adder_26 \generate_N_bit_Adder[27].genblk1.f (input1[27],
       input2[27], carry[26], sum[27], carry[27]);
  full_adder_27 \generate_N_bit_Adder[28].genblk1.f (input1[28],
       input2[28], carry[27], sum[28], carry[28]);
  full_adder_28 \generate_N_bit_Adder[29].genblk1.f (input1[29],
       input2[29], carry[28], sum[29], carry[29]);
  full_adder_29 \generate_N_bit_Adder[30].genblk1.f (input1[30],
       input2[30], carry[29], sum[30], carry[30]);
  full_adder_30 \generate_N_bit_Adder[31].genblk1.f (input1[31],
       input2[31], carry[30], sum[31], carry[31]);
  full_adder_31 \generate_N_bit_Adder[32].genblk1.f (input1[32],
       input2[32], carry[31], sum[32], carry[32]);
  full_adder_32 \generate_N_bit_Adder[33].genblk1.f (input1[33],
       input2[33], carry[32], sum[33], carry[33]);
  full_adder_33 \generate_N_bit_Adder[34].genblk1.f (input1[34],
       input2[34], carry[33], sum[34], carry[34]);
  full_adder_34 \generate_N_bit_Adder[35].genblk1.f (input1[35],
       input2[35], carry[34], sum[35], UNCONNECTED);
endmodule
