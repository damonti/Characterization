...
for REP in REPETITIONS:
    ...
    file_to_parse = "/home/20200969/Estimation/sim/fir_8bit/components/adder/tcf/adder_"+str(TOGGLE)+"percent_#"+str(REP)+".tcf"
    ...
    with open(file_to_parse,'r') as f:
        ...
        for line in lines: #find the element that corresponds to the fir_Mul instance
            ...
            #  print( [m for m in line if m.startswith("fir_Mul_")])
                    ...
                    print("At rep #"+str(REP)+"output_instance_activity = "+ str(output_instance_activity))
