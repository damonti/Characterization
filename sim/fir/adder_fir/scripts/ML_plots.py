...
plt.scatter(X_test[:,1], y_test, s=20, c = X_test[:,0]/2 , cmap='viridis')
plt.colorbar()
...
plt.scatter(X_test[:,1], y_pred, s=20, c = X_test[:,0]/2, cmap='viridis')
plt.colorbar()
...
plt.scatter(X_test[:,0], y_test, s=20, cmap='viridis')
plt.colorbar()
...
plt.scatter(X_test[:,0], y_pred, s=20, cmap='viridis')
plt.colorbar()
