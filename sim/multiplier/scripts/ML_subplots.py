...
fig.suptitle('Energy prediction ML algorithms comparison for MULTIPLIER component')
...
fig.tight_layout()
plt.savefig('ML energy multiplier.pdf')
...
fig, axs = plt.subplots(2, 2)
fig.suptitle('Area prediction ML algorithms comparison for MULTIPLIER component')
axs[0, 0].scatter(y_test, y_pred_lr, s=10)
axs[0, 0].set_title("Linear regression")
axs[1, 0].scatter(y_test, y_pred_xgb, s=10)
axs[1, 0].set_title("XGB regression")
...
axs[1, 1].set_title("Random forest regression")
fig.tight_layout()
plt.savefig('ML area multiplier.pdf')
