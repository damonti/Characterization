...
os.chdir(WORK_PATH)
for PERCENT in [12, 25, 38, 50, 62, 75, 88, 100]:
    #POWER
    os.system('joules -overwrite -batch -execute "set FACTOR '+FACTOR+'" -execute "set BW '+BW_+'" -execute "set PERCENT '+str(PERCENT)+'" -files {"./../tcl/power/power_mux.tcl"} -legacy_ui')
