...
struct fir_logic_1;
fir_logic_1::fir_logic_1(sc_module_name name) : sc_module(name) 
    ,clk("clk")
    ,rst("rst")
...
// resource: regr_en_7
void fir_logic_1::drive_dout_data_slice(){
...
void fir_logic_1::drive_din_m_busy_req_0(){
  if ( (rst.read() == 0ULL) ) {
...
// resource: mux_1bx2i2c
void fir_logic_1::drive_din_m_stalling(){
...
void fir_logic_1::drive_dout_m_req_m_trig_req(){
  if ( (rst.read() == 0ULL) ) {
...
void fir_logic_1::drive_shift_reg_7_mi12(){
...
void fir_logic_1::drive_s_reg_10(){
  if ( (rst.read() == 0ULL) ) {
    s_reg_10 = 0ULL;
  } else {
...
// resource: regr_en_sc_8
void fir_logic_1::drive_s_reg_11(){
  if ( (rst.read() == 0ULL) ) {
    s_reg_11 = 0ULL;
  } else {
    switch( (sc_uint<1>)(t_1.read()) ) {
...
// resource: regr_en_sc_8
void fir_logic_1::drive_s_reg_12(){
  if ( (rst.read() == 0ULL) ) {
    s_reg_12 = 0ULL;
  } else {
    switch( (sc_uint<1>)(t_1.read()) ) {
...
// resource: regr_en_sc_8
void fir_logic_1::drive_s_reg_13(){
  if ( (rst.read() == 0ULL) ) {
    s_reg_13 = 0ULL;
  } else {
    switch( (sc_uint<1>)(t_1.read()) ) {
...
// resource: regr_en_11
void fir_logic_1::drive_s_reg_14(){
...
// resource: regr_en_sc_8
void fir_logic_1::drive_s_reg_8(){
  if ( (rst.read() == 0ULL) ) {
    s_reg_8 = 0ULL;
  } else {
    switch( (sc_uint<1>)(t_1.read()) ) {
...
// resource: regr_en_sc_8
void fir_logic_1::drive_s_reg_9(){
  if ( (rst.read() == 0ULL) ) {
    s_reg_9 = 0ULL;
  } else {
    switch( (sc_uint<1>)(t_1.read()) ) {
...
void fir_logic_1::fir_Add_11Ux11U_11U_4_10(){
...
void fir_logic_1::fir_Mul_8Ux8U_11U_4_11(){
...
void fir_logic_1::fir_Add_11Ux11U_11U_4_12(){
...
void fir_logic_1::fir_Mul_8Ux8U_11U_4_13(){
...
void fir_logic_1::fir_Add_11Ux11U_11U_4_14(){
...
void fir_logic_1::fir_Mul_8Ux8U_11U_4_15(){
...
void fir_logic_1::fir_Add_11Ux11U_11U_4_16(){
...
void fir_logic_1::fir_Mul_8Ux8U_11U_4_17(){
...
void fir_logic_1::fir_Add_11Ux11U_11U_4_18(){
...
void fir_logic_1::fir_Mul_8Ux8U_11U_4_19(){
...
void fir_logic_1::fir_Add_11Ux11U_11U_4_20(){
...
void fir_logic_1::fir_N_Mux_8_2_10_4_21(){
...
void fir_logic_1::fir_Mul_8Ux8U_11U_4_22(){
...
void fir_logic_1::drive_rdy_0(){
  rdy_0 = !vld_0.read() | rdy_1.read();
}
// resource: mux_1bx2i1c
void fir_logic_1::drive_en_0(){
  if ( global_state.read() ) {
    en_0 = rdy_0.read();
  } else {
    en_0 = 0ULL;
...
// resource: mux_1bx2i2c
// resource: regr_en_1
void fir_logic_1::drive_cycle1_state(){
  switch( (sc_uint<2>)((sc_uint<2> )(sc_bv<2>)((sc_bv<1>)(t_1.read()), 
          (sc_bv<1>)(t_15.read()))) ) {
  case 1ULL: 
    cycle1_state = 1ULL;
...
// resource: mux_1bx2i1c
// resource: regr_en_1
void fir_logic_1::drive_cycle2_state(){
...
// resource: regr_sc_1
void fir_logic_1::drive_global_state(){
  if ( (rst.read() == 0ULL) ) {
    global_state = 0ULL;
  } else {
    global_state = 1ULL;
...
void fir_logic_1::fir_gen_busy_r_1_2_p9(){
...
void fir_logic_1::fir_N_Muxb_1_2_8_4_1(){
...
// resource: regr_en_8
void fir_logic_1::drive_din_m_stall_reg(){
...
void fir_logic_1::fir_Not_1U_1U_1_7(){
  fir_Not_1U_1U_1_7_out1 = !dout_m_req_m_trig_req.read();
}
void fir_logic_1::drive_dout_data(){
