...
// from fir.cc
#ifndef CYNTH_PART_fir_fir_logic_1_h
#define CYNTH_PART_fir_fir_logic_1_h
...
struct fir_logic_1 : public sc_module {
  sc_in<bool > clk;
  sc_in<bool > rst;
  ...
  fir_logic_1( sc_module_name name );
  SC_HAS_PROCESS(fir_logic_1);
