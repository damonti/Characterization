...
module fir(clk, rst, coeffs_table_0, coeffs_table_1, coeffs_table_2, coeffs_table_3, coeffs_table_4, coeffs_table_5, coeffs_table_6, coeffs_table_7, din_busy, din_vld, din_data, dout_busy, dout_vld, dout_data);
      ...
      reg en_1;
         ...
         // rtl_process:fir/drive_shift_reg_7_mi12
         // Sharing or Control mux
         ...
         // rtl_instance:fir/fir_Mul_8Ux8U_11U_4_8
         ...
         // rtl_instance:fir/fir_Mul_8Ux8U_11U_4_9
         // Resource=fir_Mul_8Ux8U_11U_4, Function=mul : Inputs=8,8 Outputs=11
         // Implements 1 operation(s)
         // at: fir.cc:56:32
         assign fir_Mul_8Ux8U_11U_4_9_out1 = {3'b000, coeffs_table_0}*{3'b000, s_reg_8};

         // rtl_instance:fir/fir_Add_11Ux11U_11U_4_10
         ...
         // rtl_instance:fir/fir_N_Muxb_1_2_8_4_1
         ...
         // rtl_instance:fir/fir_Not_1U_1U_4_24
         ...
         // rtl_instance:fir/fir_And_1Ux1U_1U_4_25
         ...
         // rtl_instance:fir/fir_And_1Ux1U_1U_4_26
         // Resource=fir_And_1Ux1U_1U_4, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
         ...
         // rtl_instance:fir/fir_And_1Ux1U_1U_4_27
         // Resource=fir_And_1Ux1U_1U_4, Function=and : Inputs=1,1 Outputs=1
         // Implements 1 operation(s)
