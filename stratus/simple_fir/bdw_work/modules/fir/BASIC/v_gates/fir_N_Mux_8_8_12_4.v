...
module fir_N_Mux_8_8_12_4(in9, in8, in7, in6, in5, in4, in3, in2,
     ctrl1, out1);
  ...
  NAND4XL g176(.A (n_14), .B (n_34), .C (n_29), .D (n_12), .Y
       (out1[0]));
  AOI22X1 g189(.A0 (in8[1]), .A1 (n_36), .B0 (in9[1]), .B1 (n_35), .Y
       (n_43));
  ...
  AOI22X1 g184(.A0 (in6[2]), .A1 (n_33), .B0 (in7[2]), .B1 (n_32), .Y
       (n_38));
  AOI22X1 g180(.A0 (in8[4]), .A1 (n_36), .B0 (in9[4]), .B1 (n_35), .Y
       (n_37));
  AOI22X1 g197(.A0 (in6[0]), .A1 (n_33), .B0 (in7[0]), .B1 (n_32), .Y
       (n_34));
  AOI22X1 g182(.A0 (in8[5]), .A1 (n_36), .B0 (in9[5]), .B1 (n_35), .Y
       (n_31));
  ...
  AOI22X1 g192(.A0 (in4[1]), .A1 (n_40), .B0 (in5[1]), .B1 (n_39), .Y
       (n_23));
  AOI22X1 g204(.A0 (in8[7]), .A1 (n_36), .B0 (in9[7]), .B1 (n_35), .Y
       (n_22));
  AOI22X1 g183(.A0 (in8[2]), .A1 (n_36), .B0 (in9[2]), .B1 (n_35), .Y
       (n_21));
  AOI22X1 g193(.A0 (in8[6]), .A1 (n_36), .B0 (in9[6]), .B1 (n_35), .Y
       (n_20));
  ...
  AOI22X1 g187(.A0 (in6[5]), .A1 (n_33), .B0 (in7[5]), .B1 (n_32), .Y
       (n_17));
  AOI22X1 g208(.A0 (in8[3]), .A1 (n_36), .B0 (in9[3]), .B1 (n_35), .Y
       (n_16));
  AOI22X1 g209(.A0 (in6[3]), .A1 (n_33), .B0 (in7[3]), .B1 (n_32), .Y
       (n_15));
  AOI22X1 g211(.A0 (in8[0]), .A1 (n_36), .B0 (in9[0]), .B1 (n_35), .Y
       (n_14));
