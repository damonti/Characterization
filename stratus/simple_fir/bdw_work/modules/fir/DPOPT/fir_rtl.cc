...
fir::fir(sc_module_name name) : sc_module(name) 
    ...
    ,fir_And_1Ux1U_1U_4_20_out1("fir_And_1Ux1U_1U_4_20_out1")
    ,fir_And_1Ux1U_1U_4_18_out1("fir_And_1Ux1U_1U_4_18_out1")
    ,fir_Not_1U_1U_4_17_out1("fir_Not_1U_1U_4_17_out1")
    ,fir_And_1Ux1U_1U_4_19_out1("fir_And_1Ux1U_1U_4_19_out1")
    ,fir_N_Muxb_1_2_6_4_1_out1("fir_N_Muxb_1_2_6_4_1_out1")
    ...
    ,fir_multiply_4_14_out1("fir_multiply_4_14_out1")
    ,fir_multiply_4_12_out1("fir_multiply_4_12_out1")
    ,fir_multiply_4_11_out1("fir_multiply_4_11_out1")
    ,fir_multiply_4_10_out1("fir_multiply_4_10_out1")
    ,fir_multiply_4_9_out1("fir_multiply_4_9_out1")
    ,fir_multiply_4_8_out1("fir_multiply_4_8_out1")
    ,s_reg_9("s_reg_9")
    ,s_reg_8("s_reg_8")
    ,fir_multiply_4_13_out1("fir_multiply_4_13_out1")
    ,s_reg_14("s_reg_14")
    ,en_0("en_0")
    ,fir_N_Mux_8_2_8_4_15_out1("fir_N_Mux_8_2_8_4_15_out1")
    ...
    ,fir_multiply_4_16_out1("fir_multiply_4_16_out1")
    ...
    ,en_1("en_1")
{
  ...
  SC_METHOD(fir_multiply_4_8);
  sensitive << ( s_reg_8 );
  sensitive << ( coeffs_table_0 );

  SC_METHOD(fir_multiply_4_9);
  sensitive << ( s_reg_9 );
  sensitive << ( coeffs_table_1 );
  sensitive << ( fir_multiply_4_8_out1 );

  SC_METHOD(fir_multiply_4_10);
  sensitive << ( s_reg_10 );
  sensitive << ( coeffs_table_2 );
  sensitive << ( fir_multiply_4_9_out1 );

  SC_METHOD(fir_multiply_4_11);
  sensitive << ( s_reg_11 );
  sensitive << ( coeffs_table_3 );
  sensitive << ( fir_multiply_4_10_out1 );

  SC_METHOD(fir_multiply_4_12);
  sensitive << ( s_reg_12 );
  sensitive << ( coeffs_table_4 );
  sensitive << ( fir_multiply_4_11_out1 );

  SC_METHOD(fir_multiply_4_13);
  sensitive << ( s_reg_13 );
  sensitive << ( coeffs_table_5 );
  sensitive << ( fir_multiply_4_12_out1 );

  SC_METHOD(fir_multiply_4_14);
  sensitive << ( s_reg_13 );
  sensitive << ( coeffs_table_6 );
  sensitive << ( s_reg_14 );

  SC_METHOD(fir_N_Mux_8_2_8_4_15);
  sensitive << ( din_m_stall_reg_full );
  sensitive << ( din_m_stall_reg );
  sensitive << ( din_data );

  SC_METHOD(fir_multiply_4_16);
  sensitive << ( fir_N_Mux_8_2_8_4_15_out1 );
  sensitive << ( coeffs_table_7 );
  sensitive << ( fir_multiply_4_14_out1 );
  ...
  SC_METHOD(fir_N_Muxb_1_2_6_4_1);
  sensitive << ( din_m_busy_req_0 );
  sensitive << ( din_m_unvalidated_req );
  sensitive << ( din_vld );
  ...
  SC_METHOD(fir_Not_1U_1U_4_17);
  sensitive << ( din_m_stall_reg_full );

  SC_METHOD(fir_And_1Ux1U_1U_4_18);
  sensitive << ( din_m_stalling );
  sensitive << ( din_m_data_is_valid );

  SC_METHOD(fir_And_1Ux1U_1U_4_19);
  sensitive << ( fir_Not_1U_1U_4_17_out1 );
  sensitive << ( fir_And_1Ux1U_1U_4_18_out1 );

  SC_METHOD(drive_din_m_stall_reg_full);
  sensitive << clk.pos();
  dont_initialize();

  SC_METHOD(fir_And_1Ux1U_1U_4_20);
  sensitive << ( din_m_stalling );
  sensitive << ( din_m_data_is_valid );
...
void fir::drive_dout_data_slice(){
  ...
  case 1ULL: 
    dout_data_slice = (sc_uint<7> ) (fir_multiply_4_16_out1.read().range(10,4));
    break;
  case 0ULL: 
    break;
  }
  ...
  if ( (rst.read() == 0ULL) ) {
    ...
    case 1ULL: 
      if ( cycle1_state.read() ) {
        ...
        s_reg_13 = fir_N_Mux_8_2_8_4_15_out1.read();
      }
      break;
    case 0ULL: 
      break;
...
void fir::drive_s_reg_14(){
  ...
  case 1ULL: 
    s_reg_14 = fir_multiply_4_13_out1.read();
    break;
  case 0ULL: 
    break;
  }
...
// resource: fir_multiply_4  instance: fir_multiply_4_8
void fir::fir_multiply_4_8(){
  fir_multiply_4_8_out1 = coeffs_table_0.read() * s_reg_8.read();
}
// resource: fir_multiply_4  instance: fir_multiply_4_9
void fir::fir_multiply_4_9(){
  fir_multiply_4_9_out1 = (fir_multiply_4_8_out1.read() + coeffs_table_1.read()
                           * s_reg_9.read());
}
// resource: fir_multiply_4  instance: fir_multiply_4_10
void fir::fir_multiply_4_10(){
  fir_multiply_4_10_out1 = (fir_multiply_4_9_out1.read() + coeffs_table_2.read()
                            * s_reg_10.read());
}
// resource: fir_multiply_4  instance: fir_multiply_4_11
void fir::fir_multiply_4_11(){
  fir_multiply_4_11_out1 = (fir_multiply_4_10_out1.read() + coeffs_table_3
                           .read() * s_reg_11.read());
}
// resource: fir_multiply_4  instance: fir_multiply_4_12
void fir::fir_multiply_4_12(){
  fir_multiply_4_12_out1 = (fir_multiply_4_11_out1.read() + coeffs_table_4
                           .read() * s_reg_12.read());
}
// resource: fir_multiply_4  instance: fir_multiply_4_13
void fir::fir_multiply_4_13(){
  fir_multiply_4_13_out1 = (fir_multiply_4_12_out1.read() + coeffs_table_5
                           .read() * s_reg_13.read());
}
// resource: fir_multiply_4  instance: fir_multiply_4_14
void fir::fir_multiply_4_14(){
  fir_multiply_4_14_out1 = (s_reg_14.read() + coeffs_table_6.read() * s_reg_13
                           .read());
}
// resource: fir_N_Mux_8_2_8_4
void fir::fir_N_Mux_8_2_8_4_15(){
  if ( din_m_stall_reg_full.read() ) {
    fir_N_Mux_8_2_8_4_15_out1 = din_m_stall_reg.read();
  } else {
    fir_N_Mux_8_2_8_4_15_out1 = din_data.read();
  }
}
// resource: fir_multiply_4  instance: fir_multiply_4_16
void fir::fir_multiply_4_16(){
  fir_multiply_4_16_out1 = (fir_multiply_4_14_out1.read() + coeffs_table_7
                           .read() * fir_N_Mux_8_2_8_4_15_out1.read());
}
...
void fir::drive_din_m_unvalidated_req(){
  if ( (rst.read() == 0ULL) ) {
    ...
    din_m_unvalidated_req = (sc_uint<1> ) (fir_N_Muxb_1_2_6_4_1_out1.read());
  }
}
// resource: fir_N_Muxb_1_2_6_4
void fir::fir_N_Muxb_1_2_6_4_1(){
  if ( din_m_busy_req_0.read() ) {
    fir_N_Muxb_1_2_6_4_1_out1 = (sc_uint<1> ) (din_m_unvalidated_req.read());
  } else {
    fir_N_Muxb_1_2_6_4_1_out1 = (sc_uint<1> ) (din_vld.read());
  }
}
// resource: regr_en_8
void fir::drive_din_m_stall_reg(){
  switch( (sc_uint<1>)(fir_And_1Ux1U_1U_4_19_out1.read()) ) {
  case 1ULL: 
...
// resource: fir_Not_1U_1U_4  instance: fir_Not_1U_1U_4_17
void fir::fir_Not_1U_1U_4_17(){
  fir_Not_1U_1U_4_17_out1 = !din_m_stall_reg_full.read();
}
// resource: fir_And_1Ux1U_1U_4  instance: fir_And_1Ux1U_1U_4_18
void fir::fir_And_1Ux1U_1U_4_18(){
  fir_And_1Ux1U_1U_4_18_out1 = din_m_data_is_valid.read() & din_m_stalling
                               .read();
}
// resource: fir_And_1Ux1U_1U_4  instance: fir_And_1Ux1U_1U_4_19
void fir::fir_And_1Ux1U_1U_4_19(){
  fir_And_1Ux1U_1U_4_19_out1 = fir_And_1Ux1U_1U_4_18_out1.read() & 
                               fir_Not_1U_1U_4_17_out1.read();
}
// resource: regr_sc_1
void fir::drive_din_m_stall_reg_full(){
  if ( (rst.read() == 0ULL) ) {
    ...
    din_m_stall_reg_full = (sc_uint<1> ) (fir_And_1Ux1U_1U_4_20_out1.read());
  }
}
// resource: fir_And_1Ux1U_1U_4  instance: fir_And_1Ux1U_1U_4_20
void fir::fir_And_1Ux1U_1U_4_20(){
  fir_And_1Ux1U_1U_4_20_out1 = din_m_data_is_valid.read() & din_m_stalling
                               .read();
}
