...
read_stimulus -frame_count 12 -dump_sdb 3 -allow_n_nets -format vcd -file $SIM_PATH/dump_hdl.vcd -resim_cg_enables

syn_power -effort low -to_file syn_power.jdb 

read_stimulus -file joules_1.sdb

compute_power -mode time_based -out RTL_PATH/noc.power_engine.rpt
