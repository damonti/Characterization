...
set DESIGN "router"
set TOPOLOGY "mesh_3x3_64w_5buf_2vch"
set LOCAL_DIR "[exec pwd]/.."
set SYNTH_DIR ${LOCAL_DIR}/work
set TCL_PATH "${LOCAL_DIR}/tcl"
set _REPORTS_PATH "${LOCAL_DIR}/work/tech40/${TOPOLOGY}_${DESIGN}ps_reports" 
...
set lib_list "/home_old/tech/tsmc/40nm/TSMCHOME/digital/Front_End/timing_power_noise/ECSM/tcbn40lpbwp_120b/tcbn40lpbwpwc_ecsm.lib \
    ...
    /home_old/tech/tsmc/40nm/TSMCHOME/digital/Front_End/timing_power_noise/ECSM/tcbn40lpbwplvt_120b/tcbn40lpbwplvtwc_ecsm.lib"
