...
set _REPORTS_PATH "${LOCAL_DIR}/work/${DATE}_${CLOCK_PERIOD}_${TECH_CORNER}_reports" 
set _OUTPUTS_PATH "${LOCAL_DIR}/work/${DATE}_${CLOCK_PERIOD}_${TECH_CORNER}_outputs" 
...
set LIB_LIST "/opt/tech/tsmc/40nm/TSMCHOME/digital/Front_End/timing_power_noise/ECSM/tcbn40lpbwp12t40m1plvt_200a/tcbn40lpbwp12t40m1plvtbc_ecsm.lib"
