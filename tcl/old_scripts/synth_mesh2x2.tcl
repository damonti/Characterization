...
set DESIGN "noc"
set TOPOLOGY "mesh_4x4_32width_5buf"
...
set RTL_PATH "$LOCAL_DIR/rtl/nocgen/mesh_2x2_32width_5buf"
...
write_hdl -generic -abstract > $_REPORTS_PATH/netlist/generic/$DESIGN.generic.v
