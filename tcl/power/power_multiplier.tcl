...
read_netlist $RTL_PATH/netlist/${DESIGN}_${BW}_${PIPELINE}_netlist.v
...
foreach PERCENT $listPERCENT {
    set START 1650
    set END 1830
    set TB "${DESIGN}_${BW}_${PIPELINE}_${PERCENT}percent"
    read_stimulus -start ${START}ns -end ${END}ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}.vcd -dut_instance /tb_multiplier/multiplier
