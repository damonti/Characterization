...
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/init_tb1} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_${ALIAS}.rpt
...
read_stimulus -start ${START}ns -end ${END}ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/idle_tb1} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_${ALIAS}.rpt
...
read_stimulus -start ${START}ns -end ${END}ns -interval_size 10ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/message_tb2/frame#[1:20]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_message.rpt
report_power -stims {/message_tb2/frame#[16:18]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_flit.rpt
...
read_stimulus -start ${START}ns -end ${END}ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/init_tb2} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_${ALIAS}.rpt
...
read_stimulus -start ${START}ns -end ${END}ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/idle_tb2} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_${ALIAS}.rpt
