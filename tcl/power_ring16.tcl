set TOPOLOGY ring16_8buf_2vch_cg
...
set END 370
set ALIAS message
read_stimulus -start ${START}ns -end ${END}ns -interval_size 10ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/message_tb1/frame#[1:20]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_message.rpt
report_power -stims {/message_tb1/frame#[8:9]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_flit.rpt

set START 0
set END 130
set ALIAS init
read_stimulus -start ${START}ns -end ${END}ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/init_tb1/frame#[1:13]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_${ALIAS}.rpt
...
read_stimulus -start ${START}ns -end ${END}ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/idle_tb1/frame#[1:10]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_${ALIAS}.rpt
...
read_stimulus -start ${START}ns -end ${END}ns -interval_size 10ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/message_tb2/frame#[1:9]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_message.rpt
report_power -stims {/message_tb2/frame#[4:6]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_flit.rpt
...
read_stimulus -start ${START}ns -end ${END}ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/init_tb2/frame#[1:13]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}}_${ALIAS}.rpt
...
read_stimulus -start ${START}ns -end ${END}ns -allow_n_nets -format vcd -file $SIM_PATH/dump_${TB}_${CK}.vcd -dut_instance /noc_test/noc -alias ${ALIAS}_${TB}
compute_power -mode time_based -stim /${ALIAS}_${TB} -append
report_power -stims {/idle_tb2/frame#[1:10]} -levels all -by_hierarchy -indent_inst -levels all -header -cols "cells static dynamic total" -unit nW > ${SIM_PATH}/noc.power_joules_${TOPOLOGY}_${TB}_${CK}_${ALIAS}.rpt
